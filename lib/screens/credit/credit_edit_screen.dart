  ...
  Widget build(BuildContext context) {
    return LayoutWhite(
      ...
      child: Padding(
        ...
        //      codeController.text = maskCode.maskText(state.item.code);
              codeController.text = state.item.code;
              expiryController.text = state.item.expiry;
              cvvController.text = state.item.cvv;

       //       code4=maskCode.maskText(state.item.code).substring(15,19);
    //          code4=state.item.code.substring(12,16);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    //    if (_formKey.currentState.validate()) {
                          ...
                          //    code: maskCode.unmaskText(codeController.text),
                      ...
                      child: Container(
                          ...
                          margin:
                              EdgeInsets.only(right: 30, top: 50, bottom: 30),
                          decoration: BoxDecoration(
